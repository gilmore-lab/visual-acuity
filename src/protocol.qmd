...
Gray sources are sources we do not currently have in Paperpile. Green sources indicate we already have collected them in Paperpile. 
...
7. Copy citation from Paperpile (command+c) and paste into 'citation' field in Google Sheet.
